...
CREATE TABLE exhibit (
    ...
    art_id               NUMBER(4) NOT NULL,
    artist_artist_code   NUMBER(4) NOT NULL,
...
COMMENT ON COLUMN exhibit.artist_artist_code IS
    'artist code';
...
COMMENT ON COLUMN movement.artist_artist_code IS
    'artist code';
...
CREATE TABLE sale (
    ...
    cust_id                      NUMBER(4) NOT NULL,
    gallery_gal_id               NUMBER(4) NOT NULL,
    artwork_art_id               NUMBER(4) NOT NULL,
...
COMMENT ON COLUMN sale.gallery_gal_id IS
    'gallery id';

COMMENT ON COLUMN sale.artwork_art_id IS
    'artowrk id';

COMMENT ON COLUMN sale.artwork_artist_artist_code IS
    'artist code';
...
ALTER TABLE sale
    ADD CONSTRAINT sale_exhibit_fk FOREIGN KEY ( gallery_gal_id,
                                                 artwork_art_id,
                                                 artwork_artist_artist_code )
